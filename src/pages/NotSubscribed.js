...
export default function NotSubscribed({ disabled }) {
  ...
  return (
    <div className="z-30 absolute px-6 flex items-center justify-center w-full md:w-[calc(100vw-160px)] h-[calc(100vh-0px)] ">
      <div className="bg-stone-100 px-6 sm:px-12 py-6 sm:py-10  rounded-3xl drop-shadow-xl ">
        {disabled ? (
