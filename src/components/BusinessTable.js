  ...
  return (
    <div className="w-full sm:max-w-[720px] sm:mr-auto sm:ml-auto xl:ml-auto xl:mr-0">
      <div className="">
        ...
        <div className="h-[21rem] min-w-80 w-full inline-block shadow-2xl rounded-3xl">
          <div className="px-2 sm:px-6">
            ...
            <div className="h-64 overflow-y-auto scrollbar-thin scrollbar-thumb-gray-200 ">
              <div className="mb-1 px-0 sm:px-4 rounded bg-[#EEF7FF] w-full grid grid-cols-5 text-base text-black font-medium">
